...
<div class="nicdark_site">
    <div class="nicdark_site_fullwidth nicdark_clearfix">
        ...
        <div class="nicdark_right_sidebar nicdark_bg_greydark nicdark_nicescrool">
            ...
            <a
                class="nicdark_right_sidebar_btn_close nicdark_btn_icon small nicdark_bg_red nicdark_radius white nicdark_absolute_right10 nicdark_shadow"><i
                    ...
                    <ul class="nicdark_list nicdark_relative">
                        <li>
                            <img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60"
                                src="{{asset('/site/img/woocommerce/small/img1.jpg')}}">
                        ...
                        <li>
                            <img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60"
                                src="{{asset('/site/img/woocommerce/small/img3.jpg')}}">
                            <div class="nicdark_activity nicdark_marginleft80">
            ...
            <div class="nicdark_margin020">
                ...
                <div class="nicdark_focus">
                    <a href="#" class="nicdark_btn nicdark_bg_green small nicdark_shadow nicdark_radius white"><i
            ...
            <div class="nicdark_margin020">
                <input class="nicdark_bg_greydark white subtitle small nicdark_padding0 nicdark_slider_amount"
                    type="text">
                <div class="nicdark_space20"></div>
                <a href="#" class="nicdark_btn nicdark_bg_yellow small nicdark_shadow nicdark_radius white"><i
            ...
            <div class="nicdark_textevidence">
                <div class="nicdark_margin20">
                    <ul class="nicdark_list nicdark_relative">
                        <li>
                            <img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60"
                                src="{{asset('/site/img/woocommerce/small/img2.jpg')}}">
                            <div class="nicdark_activity nicdark_marginleft80">
                        ...
                        <li>
                            <img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60"
                                src="{{asset('/site/img/woocommerce/small/img4.jpg')}}">
                            <div class="nicdark_activity nicdark_marginleft80">
            ...
            <div class="nicdark_margin20">
                ...
                <div class="nicdark_space20"></div>
                <a href="#" class="nicdark_btn nicdark_bg_blue small nicdark_shadow nicdark_radius white"><i
                    ...
                    <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="nicdark_focus">
                                <h6 class="white">
                                    <i class="icon-calendar-outlilne"></i>&nbsp;&nbsp;<a class="white"
                                        href="events.html">OUR EVENTS</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <i class="icon-pencil-1"></i>&nbsp;&nbsp;<a class="white"
                                        href="blog-masonry.html">NEWS</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="grid grid_6 right">
                            <div class="nicdark_focus right">
                                <h6 class="white">
                                    <i class="icon-globe-alt-outline"></i>&nbsp;&nbsp;<a
                                        class="white nicdark_mpopup_window" href="#nicdark_window">LANGUAGES</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <ul class="nicdark_list border">
                                    ...
                                    <li class="nicdark_border_grey">
                                        <p><a class="grey" href="index.html">ENGLISH</a><a href="index.html"
                                                class="nicdark_btn right nicdark_opacity"><img alt="" width="30"
                                                    src="{{asset('/site/img/flag/img1.png')}}"></a></p>
                                    ...
                                    <li class="nicdark_border_grey">
                                        ...
                                        <p><a class="grey" href="index.html">RUSSIAN</a><a href="index.html"
                                                class="nicdark_btn right nicdark_opacity"><img alt="" width="30"
                                                    src="{{asset('/site/img/flag/img2.png')}}"></a></p>
                                        <div class="nicdark_space15"></div>
                                    </li>
                                    ...
                                    <li class="nicdark_border_grey">
                                        ...
                                        <p><a class="grey" href="index.html">ARABIC</a><a href="index.html"
                                                class="nicdark_btn right nicdark_opacity"><img alt="" width="30"
                                                    src="{{asset('/site/img/flag/img3.png')}}"></a></p>
                                        <div class="nicdark_space15"></div>
                                    </li>
                                    ...
                                    <li class="nicdark_border_grey">
                                        ...
                                        <p><a class="grey" href="index.html">ITALIAN</a><a href="index.html"
                                                class="nicdark_btn right nicdark_opacity"><img alt="" width="30"
                                                    src="{{asset('/site/img/flag/img4.png')}}"></a></p>
                                    </li>
                    ...
                    <div class="nicdark_container nicdark_clearfix">
                        ...
                        <div class="grid grid_12 percentage">
                            ...
                            <div class="nicdark_logo nicdark_marginleft10">
                                <a href="index.html"><img alt="" src="{{asset('/site/img/logo.png')}}"></a>
                            </div>

                            <a
                                class="nicdark_btn_icon nicdark_zoom nicdark_bg_yellow_hover nicdark_right_sidebar_btn_open nicdark_marginright10 nicdark_bg_orange extrasmall nicdark_radius white right"><i
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="components-archives.html">Archives Solutions</a>
                                                    </li>
                                    ...
                                    <li class="green">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub-menu">
                                                    <li><a href="single-post-left-sidebar.html">Left Sidebar</a>
                                                    </li>
                                                    <li><a href="single-post-right-sidebar.html">Right Sidebar</a>
                                                    </li>
                ...
                <div class="nicdark_slide1">
                    ...
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on"
                            data-title="LESSON">
                            <img src="{{asset('/site/img/slide/img3.jpg')}}" alt="" data-lazyload="img/slide/img3.jpg"
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
                            data-title="FRIENDS">
                            <img src="{{asset('/site/img/slide/img1.jpg')}}" alt="" data-lazyload="img/slide/img1.jpg"
                    ...
                    <div class="nicdark_textevidence center">
                        <div
                            ...
                            <div class="nicdark_textevidence">
                                ...
                                <i
                                    class="nicdark_zoom icon-pencil-2 nicdark_iconbg left extrabig blue nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                            </div>
                        </div>
                        <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_yellow nicdark_shadow">
                            <div class="nicdark_textevidence">
                                ...
                                <i
                                    class="nicdark_zoom icon-money-1 nicdark_iconbg left extrabig yellow nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                            </div>
                        </div>
                        <div class="nicdark_textevidence nicdark_width_percentage25 nicdark_bg_orange nicdark_shadow">
                            <div class="nicdark_textevidence">
                                ...
                                <i
                                    class="nicdark_zoom icon-music-2 nicdark_iconbg left extrabig orange nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="nicdark_textevidence">
                                <div class="nicdark_margin30">
                                    <h2 class="white subtitle"><a class="white" href="teachers.html">TEACHERS</a>
                                    </h2>
                                </div>
                                <i
                                    class="nicdark_zoom icon-graduation-cap-1 nicdark_iconbg left extrabig green nicdark_displaynone_ipadland nicdark_displaynone_ipadpotr"></i>
                            </div>
                        </div>
        ...
        <section class="nicdark_section">
            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_12">
                    ...
                    <div class="nicdark_space20"></div>
                    <div class="nicdark_divider left big"><span class="nicdark_bg_yellow nicdark_radius"></span>
                    </div>
                    <div class="nicdark_space10"></div>
                </div>
                ...
                <div class="grid grid_4 nicdark_relative">
                    ...
                    <div
                        class="nicdark_btn_iconbg nicdark_bg_yellow nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                        <div>
                    ...
                    <div class="nicdark_activity nicdark_marginleft100">
                        <h4>CUSTOM FOOD</h4>
                        <div class="nicdark_space20"></div>
                        <p>Lorem ipsum dolor sit amet, consec adipiscing elit. Pellentesque tincidunt rutrum sapien,
                            sed ultricies diam.</p>
                        <div class="nicdark_space20"></div>
                ...
                <div class="grid grid_4 nicdark_relative">
                    ...
                    <div
                        class="nicdark_btn_iconbg nicdark_bg_orange nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                        <div>
                ...
                <div class="grid grid_4 nicdark_relative">
                    ...
                    <div
                        class="nicdark_btn_iconbg nicdark_bg_green nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                        <div>
                ...
                <div class="grid grid_4 nicdark_relative">
                    ...
                    <div
                        class="nicdark_btn_iconbg nicdark_bg_blue nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                        <div>
                ...
                <div class="grid grid_4 nicdark_relative">
                    ...
                    <div
                        class="nicdark_btn_iconbg nicdark_bg_violet nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                        <div>
                ...
                <div class="grid grid_4 nicdark_relative">
                    ...
                    <div
                        class="nicdark_btn_iconbg nicdark_bg_red nicdark_absolute extrabig nicdark_shadow nicdark_radius">
                        <div>
        ...
        <section class="nicdark_section">
            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_12">
                    ...
                    <div class="nicdark_space20"></div>
                    <div class="nicdark_divider left big"><span class="nicdark_bg_green nicdark_radius"></span>
                    </div>
                    <div class="nicdark_space10"></div>
                </div>
                ...
                <div class="grid grid_3">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_green nicdark_radius nicdark_shadow">
                        ...
                        <img alt="" src="{{asset('/site/img/events/img1.jpg')}}">
                ...
                <div class="grid grid_3">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                        ...
                        <img alt="" src="{{asset('/site/img/events/img2.jpg')}}">
                ...
                <div class="grid grid_3">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                        ...
                        <img alt="" src="{{asset('/site/img/events/img3.jpg')}}">
                ...
                <div class="grid grid_3">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                        ...
                        <img alt="" src="{{asset('/site/img/events/img4.jpg')}}">
            ...
            <div class="nicdark_filter greydark">
                ...
                <div class="nicdark_container nicdark_clearfix">
                    ...
                    <div class="grid grid_12">
                        ...
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider center big"><span class="nicdark_bg_white nicdark_radius"></span>
                        </div>
                        <div class="nicdark_space20"></div>
                    </div>
        ...
        <section class="nicdark_section">
            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_12">
                    ...
                    <div class="nicdark_space20"></div>
                    <div class="nicdark_divider left big"><span class="nicdark_bg_orange nicdark_radius"></span>
                    </div>
                    <div class="nicdark_space10"></div>
                </div>
                ...
                <div class="grid grid_6">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                        ...
                        <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                            <img alt="" class="nicdark_radius_left nicdark_opacity"
                                src="{{asset('/site/img/team/img1.jpg')}}">
                        </div>

                        <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                            <div class="nicdark_margin20">

                                <h4 class="white"><a class="white" href="single-teacher.html">JULIETTE LIGHT</a>
                                </h4>
                                <div class="nicdark_space20"></div>
                                <div class="nicdark_divider left small"><span
                                        class="nicdark_bg_white nicdark_radius"></span></div>
                                <div class="nicdark_space20"></div>
                                <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit
                ...
                <div class="grid grid_6">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                        ...
                        <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                            <img alt="" class="nicdark_radius_left nicdark_opacity"
                                src="{{asset('/site/img/team/img2.jpg')}}">
                        </div>
                ...
                <div class="grid grid_6">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                        ...
                        <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                            <img alt="" class="nicdark_radius_left nicdark_opacity"
                                src="{{asset('/site/img/team/img3.jpg')}}">
                        </div>
                ...
                <div class="grid grid_6">
                    ...
                    <div class="nicdark_archive1 nicdark_bg_violet nicdark_radius nicdark_shadow">
                        ...
                        <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                            <img alt="" class="nicdark_radius_left nicdark_opacity"
                                src="{{asset('/site/img/team/img4.jpg')}}">
                        </div>
                ...
                <div class="nicdark_masonry_container">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item educational">
                        <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img1.jpg')}}">
                            ...
                            <div class="nicdark_margin20">
                                ...
                                <div class="nicdark_divider left small"><span
                                        class="nicdark_bg_white nicdark_radius"></span></div>
                                <div class="nicdark_space20"></div>
                                <p class="white">Lorem ipsum dolor sit amet, consectetur adcing elit Lorem ipsum
                                    dolor sit amet, consectetur adip iscing elit psum dolor sit amet.</p>
                                <div class="nicdark_space20"></div>
                    ...
                    <div class="grid grid_4 nicdark_masonry_item educational">
                        <div class="nicdark_archive1 nicdark_bg_violet nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img2.jpg')}}">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item excursions">
                        <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img4.jpg')}}">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item excursions">
                        <div class="nicdark_archive1 nicdark_bg_red nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img3.jpg')}}">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item excursions">
                        <div class="nicdark_archive1 nicdark_bg_green nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img5.jpg')}}">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item educational">
                        <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img7.jpg')}}">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item excursions">
                        <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img8.jpg')}}">
                    ...
                    <div class="grid grid_4 nicdark_masonry_item excursions">
                        <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                            ...
                            <img alt="" src="{{asset('/site/img/blog/img6.jpg')}}">
