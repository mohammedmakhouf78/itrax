            ...
            <div class="bg">
                ...
                <form @submit="submit" method="POST">
                    <div class="form-control">
                        ...
                        <input v-model="myPost.title" type="text" id="title" placeholder="Post Title">
                    </div>
                    <div class="form-control">
                        <label for="description">
                            <i class="fas fa-user"></i>
                        </label>
                        <input v-model="myPost.description" type="text" id="description" placeholder="Post Description">
                    </div>
                    <div class="form-control">
...
export default {
    ...
    methods: {
        submit:function(e){
            ...
            this.$axios.post('UpdateBlog.php',
            formData,
            {
                header:{
        ...
        deleteBlog(id){
            ...
            this.$axios.post('DeletePost.php',
            formData)
            .then(res => {
               if(res.data.success){
