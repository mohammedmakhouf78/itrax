            ...
            <div class="widget-content widget-content-area">
                <form method="post" action="{{route('admin.activity.update',$activity->id)}}"
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input name="title" type="text" class="form-control" id="title" value="{{$activity->title}}">
                        @error('title')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="slug" class="form-control" id="slug" rows="3">{{$activity->slug}}</textarea>
                        @error('slug')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
