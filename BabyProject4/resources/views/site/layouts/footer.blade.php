    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                ...
                <a href="contact-1.html"
                    class="nicdark_btn_icon nicdark_bg_orange small nicdark_shadow nicdark_radius white"><i
                        class="icon-mail-1 nicdark_rotate"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="contact-1.html"
                    class="nicdark_btn_icon nicdark_bg_yellow small nicdark_shadow nicdark_radius white"><i
                        class="icon-home nicdark_rotate"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="contact-1.html"
                    class="nicdark_btn_icon nicdark_bg_red small nicdark_shadow nicdark_radius white"><i
                        class="icon-phone-outline nicdark_rotate"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                        src="{{asset('/site/img/footer/img1.jpg')}}">
                </div>
            </div>
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                        src="{{asset('/site/img/footer/img2.jpg')}}">
                </div>
            </div>
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                        src="{{asset('/site/img/footer/img3.jpg')}}">
                </div>
            </div>
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                        src="{{asset('/site/img/footer/img4.jpg')}}">
                </div>
            </div>
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                        src="{{asset('/site/img/footer/img5.jpg')}}">
                </div>
            </div>
            ...
            <div class="grid nomargin grid_4 percentage">
                <div class="nicdark_margin10">
                    <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                        src="{{asset('/site/img/footer/img6.jpg')}}">
                </div>
            </div>
        ...
        <div class="grid grid_3 nomargin percentage">
            ...
            <div class="nicdark_margin10">
                ...
                <input class="nicdark_bg_greydark2 nicdark_radius nicdark_shadow white small subtitle" type="text"
                    value="" placeholder="EMAIL">
                <div class="nicdark_space20"></div>
                <textarea rows="3" class="nicdark_bg_greydark2 nicdark_radius nicdark_shadow white small subtitle"
                ...
                <a href="submit-message.html"
                    class="nicdark_mpopup_ajax nicdark_btn nicdark_bg_green small nicdark_shadow nicdark_radius white nicdark_press">SEND</a>
            </div>
        </div>
...
<div class="nicdark_section nicdark_bg_greydark2 nicdark_copyrightlogo">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6 nicdark_aligncenter_iphoneland nicdark_aligncenter_iphonepotr">
            <div class="nicdark_space20"></div>
            <p class="white">© Copyright 2014 by <span class="grey">NicDark</span>Themes.com - Made With <i
                    class="icon-heart-filled red nicdark_zoom"></i> In Venice</p>
        </div>
...
<!--main-->
<script src="{{asset('/site/js/main/jquery.min.js')}}"></script>
<!--Jquery-->
<script src="{{asset('/site/js/main/jquery-ui.js')}}"></script>
<!--Jquery UI-->
<script src="{{asset('/site/js/main/excanvas.js')}}"></script>
<!--canvas need for ie-->

<!--plugins-->
<script src="{{asset('/site/js/plugins/revslider/jquery.themepunch.tools.min.js')}}"></script>
<!--revslider-->
<script src="{{asset('/site/js/plugins/revslider/jquery.themepunch.revolution.min.js')}}"></script>
<!--revslider-->

<!--menu-->
<script src="{{asset('/site/js/plugins/menu/superfish.min.js')}}"></script>
<!--superfish-->
<script src="{{asset('/site/js/plugins/menu/tinynav.min.js')}}"></script>
<!--tinynav-->

<!--other-->
<script src="{{asset('/site/js/plugins/isotope/isotope.pkgd.min.js')}}"></script>
<!--isotope-->
<script src="{{asset('/site/js/plugins/mpopup/jquery.magnific-popup.min.js')}}"></script>
<!--mpopup-->
<script src="{{asset('/site/js/plugins/scroolto/scroolto.js')}}"></script>
<!--Scrool To-->
<script src="{{asset('/site/js/plugins/nicescrool/jquery.nicescroll.min.js')}}"></script>
<!--Nice Scroll-->
<script src="{{asset('/site/js/plugins/inview/jquery.inview.min.js')}}"></script>
<!--inview-->
<script src="{{asset('/site/js/plugins/parallax/jquery.parallax-1.1.3.js')}}"></script>
<!--parallax-->
<script src="{{asset('/site/js/plugins/countto/jquery.countTo.js')}}"></script>
<!--jquery.countTo-->
<script src="{{asset('/site/js/plugins/countdown/jquery.countdown.js')}}"></script>
<!--countdown-->

<!--settings-->
<script src="{{asset('/site/js/settings.js')}}"></script>
<!--settings-->
<!--custom js-->
